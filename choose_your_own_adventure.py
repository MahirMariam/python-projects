...
if answer == "left":
    ...
    if answer == "swim":
        ...
        print("You walked for many miles, ean out of water and you lost the game.")
    else:
        print('Not a valid option. You lose.')

elif answer == "right":
    answer = input(
        "You come to a bridge, it looks woobly, do you want to cross it or head back (cross/back)? ")
